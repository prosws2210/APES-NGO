      ...
      <div className="flex flex-row gap-10 items-center justify-center">
        ...
        <div className="relative mb-8">
          ...
          <img
            ...
            height="900"
            src="/assets/images/education images/image_4.jpg"
            width="900"
          />
        </div>
        ...
        <div className='flex flex-col ml-4 space-y-4 pt-6'>
          <h1 className="text-3xl text-center font-bold text-gray-800">
            "Empowering Minds, Building Futures: Transformative Education Initiatives by Empowerment Through Education (ETE) NGO"
          </h1>
