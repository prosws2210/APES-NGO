...
const Home_KeyFeatures = () => {
  return (
    <div className='px-12 py-4 bg-violet-50'>
      {/* 1st Feature */}
        <div className="flex items-center px-8 pt-4 pb-4 bg-white rounded-2xl shadow-lg m-5">
          {/* Photo on the left */}
          ...
          {/* Text on the right */}
          <div className="max-w">
            <h2 className="text-2xl font-bold mb-4">APES NGO - HEALTHCARE</h2>
      ...
      <div className="flex items-center px-8 pt-4 pb-4 bg-white rounded-2xl shadow-lg m-5">
        {/* Text on the left */}
        <div className="max-w">
          <h2 className="text-2xl font-bold mb-4">APES NGO - EDUCATION</h2>
          <p className="text-gray-700">
            At APES NGO, we are dedicated to fostering positive change and sustainable development within communities worldwide. Our commitment to advancing social and environmental causes is unwavering, as we strive to create a better future for all.
          </p>
      ...
      <div className="flex items-center px-8 pt-4 pb-4 bg-white rounded-2xl shadow-lg m-5">
        ...
        {/* Text on the right */}
        <div className="max-w">
          <h2 className="text-2xl font-bold mb-4">APES NGO - DIETARY AND HEALTHY FOOD</h2>
          <p className="text-gray-700">
            At APES NGO, we are dedicated to fostering positive change and sustainable development within communities worldwide. Our commitment to advancing social and environmental causes is unwavering, as we strive to create a better future for all.
          </p>
      ...
      <div className="flex items-center px-8 pt-4 pb-4 bg-white rounded-2xl shadow-lg m-5">
        {/* Text on the left */}
        <div className="max-w">
          <h2 className="text-2xl font-bold mb-4">APES NGO - SOCIAL CAUSE</h2>
          <p className="text-gray-700">
            At APES NGO, we are dedicated to fostering positive change and sustainable development within communities worldwide. Our commitment to advancing social and environmental causes is unwavering, as we strive to create a better future for all.
          </p>
