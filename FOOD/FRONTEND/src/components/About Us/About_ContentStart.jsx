      ...
      <div className="flex flex-row gap-10 items-center justify-center">
        ...
        <div className="relative mb-8">
          ...
          <img
            ...
            height="1000"
            src="/assets/images/food/food5.jpeg"
            width="1000"
          />
        </div>  
        ...
        <div className='flex flex-col ml-4 space-y-4 pt-6'>
          <h1 className="text-3xl text-center font-bold text-gray-800">
            "Flavors of Unity: Bringing Communities Together Through the Shared Love of Good Food, Where Every Dish Tells a Story of Diversity and Harmony!"
          </h1>
